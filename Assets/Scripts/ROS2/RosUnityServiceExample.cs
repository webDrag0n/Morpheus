...
public class RosUnityServiceExample : MonoBehaviour
{
    ...
    [SerializeField]
    string m_h1_right_shoulder_pitch = "right_shoulder_pitch_srv";
    ...
    //private ObjectPoseServiceResponse GetUnitreeH1Pose(ObjectPoseServiceRequest request)
    //{
    //    Debug.Log("Received request for h1: " + request.object_name);
